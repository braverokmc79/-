 ...
 * coodiv team
 -------------------------------------------------------------------*/
	...
	$(function(){
		$("#typed").typed({
			strings: ["국내최대방어량", "1TB 서비스제공","국내최대방어량"],
			typeSpeed: 78,
			loop:true,
		});
	});
    ...
    // });
	  ...
	  $(function(){
       $(".heaer-color-change").on("mouseover", function(){
              const id=$(this).attr("data-id");
              console.log(id);
              $("#"+id).css("background","#020507");

       });
       $(".heaer-color-change").on("mouseleave", function(){
              const id=$(this).attr("data-id");
              console.log(id);
              $("#"+id).css("background","#343a40");
       });
    });
